...
namespace QuantConnect.DataSource.MetaTrader
{
    ...
    public class NewsItem : IndexedBaseData
    {
        /// <summary>
        /// Data source ID
        /// </summary>
        ...
        public override SubscriptionDataSource GetSource(SubscriptionDataConfig config, DateTime date, bool isLiveMode)
        {
            if (isLiveMode)
            {
                ...
                var tiingoTicker = config.Symbol;
                var url = Invariant($"https://api.tiingo.com/tiingo/news?tickers={tiingoTicker}&startDate={date:yyyy-MM-dd}&&sortBy=crawlDate");
        ...
        {
            var data = JsonConvert.DeserializeObject<List<NewsItem>>(content);
